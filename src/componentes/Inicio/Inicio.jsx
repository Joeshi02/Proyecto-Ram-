        ...
        <>
            <div className="flex flex-col">
                <div className="flex items-center justify-around m-14">
                    <div>
                        <div className="flex justify-center flex-col items-center m-2 text-center">
                            ...
                            <h2 className="text-3xl"> Somos una red de asistencia mental y atencion médica.</h2>
                ...
                <div className="text-center">
                    <h3>Ofrecemos un servicio de calidad basado en la atención, el respeto, confianza, calidez y la responsabilidad que nos caracterizan.</h3>
                </div>
                <div className="flex items-center justify-around m-14 flex-wrap sm:flex-nowrap">
                    ...
                    <div className="w-full sm:w-1/2 flex">
                        <div className="flex-col justify-center items-center w-full sm:w-80 mx-auto my-auto">
                            ...
                            <p>Y mucho más.</p>
                            <button className="m-4 p-3 bg-green-600 rounded-xl w-full sm:w-80">
                                <Link to="/profesionales">Comienza ahora</Link>
                            </button>
                        </div>
                    </div>
                        ...
                        <div className="m-4 p-4 w-full flex flex-col items-center sm:flex-row sm:justify-center">
                            <div className="mb-4 sm:mb-0 sm:mr-4">
                                <div className="flex flex-row items-center">
                                    ...
                                    <p className="text-3xl m-1.5">Elige a tu psicólogo</p>
                                </div>
                        ...
                        <div className="m-4 p-4 w-full flex flex-col items-center sm:flex-row sm:justify-center">
                            <div className="mb-4 sm:mb-0 sm:mr-4">
                                <div className="flex flex-row items-center">
                                    ...
                                    <p className="text-3xl m-1.5">Agenda tu cita online</p>
                                </div>
                                <div className="w-full sm:w-96">
                ...
                <div>
                    <p className="flex justify-center text-2xl">Preguntas frecuentes </p>
                </div>
                <div className="flex justify-center ">
                    <Acordiones />
                </div>
                ...
                <div className="bg-formFAQ">
                    <div className="flex-col justify-center">
                        <p className="text-center text-2xl">Preguntas frecuentes</p>
